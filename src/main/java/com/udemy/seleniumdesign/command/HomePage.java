...
public class HomePage {
    ...
    public List<ElementValidator> getElementValidators() {
        return Arrays.asList(
                // notification
                new NotificactionValidator(infoBtn, infoAlert),
                new NotificactionValidator(successBtn, successAlert),
                new NotificactionValidator(warnBtn, warnAlert),
                new NotificactionValidator(dangerBtn, dangerAlert),
                // dismiss
